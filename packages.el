  ...
  (use-package irony
    ...
    (progn
      ...
      (add-hook 'irony-mode-hook
                (lambda ()
                  (local-set-key [f9] 'helm-projectile-find-other-file)))
      (add-hook 'irony-mode-hook
                (lambda ()
                  (local-set-key [f5] 'irony/my-projectile-compile-project)))
...
(defun irony/my-projectile-compile-project (&optional prompt)
  (interactive "P")
